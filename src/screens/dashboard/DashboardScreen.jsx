      ...
      <div className="despensador-welcome">
        <style>{`
          ...
          .despensador-welcome h3 {
            ...
            font-size: 1.6rem; color: #1a1a1a; margin: 0;
          ...
          .despensador-hint {
            ...
            font-size: 0.85rem; color: #1a1a1a; font-weight: 600;
            margin-top: 8px;
          }
        `}</style>
  ...
  return (
    <>
      <style>{`
        ...
        .dash-title i { color: #FFCC00; }
        .dash-subtitle { font-size: 0.85rem; color: #94a3b8; margin: 2px 0 0; }
        .dash-date-badge {
          display: inline-flex; align-items: center; gap: 6px;
          background: #fff; border: 1.5px solid rgba(255,204,0,0.3);
        ...
        .caja-banner.open  { background: linear-gradient(135deg, #15803d, #16a34a, #22c55e); }
        ...
        .stat-card.dark .stat-label { color: rgba(255,255,255,0.6) !important; }
        .stat-card.dark .stat-value { color: #FFCC00 !important; }
        .stat-card.dark .stat-sub   { color: rgba(255,255,255,0.5) !important; }
        .stat-card.dark .stat-card-icon { background: rgba(255,204,0,0.15); color: #FFCC00; }

        .stat-card-icon {
          width: 48px; height: 48px; border-radius: 13px;
          background: rgba(255,204,0,0.12);
          display: flex; align-items: center; justify-content: center;
          font-size: 1.4rem; color: var(--accent, #FFCC00);
          flex-shrink: 0;
        ...
        .stat-value {
          ...
          color: var(--accent, #1a1a1a); line-height: 1.1;
          white-space: nowrap; overflow: hidden; text-overflow: ellipsis;
        }
        .stat-sub { font-size: 0.75rem; color: #aaa; margin-top: 4px; font-weight: 500; }

        .stat-card-glow {
          position: absolute; top: -30px; right: -30px;
          width: 80px; height: 80px; border-radius: 50%;
          background: radial-gradient(circle, var(--accent, rgba(255,204,0,0.2)), transparent 70%);
        ...
        .moneda-card.usd { background: linear-gradient(135deg, #15803d 0%, #16a34a 60%, #22c55e 100%); }
        ...
        .rank-title {
          font-family: 'Arial Black', sans-serif; font-weight: 900;
          font-size: 0.95rem; color: #1a1a1a; margin: 0;
          text-transform: uppercase;
        }
        ...
        .rank-row:hover { background: rgba(255,204,0,0.06); }
        ...
        .rank-label { font-size: 0.7rem; color: #aaa; font-weight: 500; }
        .rank-empty {
          display: flex; flex-direction: column; align-items: center;
          padding: 2rem; gap: 8px; color: #ccc;
        }
        ...
        .stock-table td { padding: 10px 18px; font-size: 0.875rem; border: none; border-top: 1px solid rgba(0,0,0,0.05); }
        .stock-table tr:hover td { background: rgba(255,204,0,0.04); }
        .stock-name { font-weight: 600; color: #1a1a1a; }
        .stock-badge-low {
          display: inline-flex; align-items: center;
      ...
      <Row className="g-3">
        <Col xs={12} lg={6}>
          <div className="rank-card">
            <div className="rank-card-header">
              <div className="rank-card-header-icon" style={{ background: 'rgba(255,204,0,0.12)' }}>
        ...
        <Col xs={12} lg={6}>
          <div className="rank-card" style={{ animationDelay: '80ms' }}>
            <div className="rank-card-header">
              <div className="rank-card-header-icon" style={{ background: 'rgba(255,204,0,0.12)' }}>
                <i className="bi bi-stars" style={{ color: '#FFCC00' }} />
              </div>
              <div>
