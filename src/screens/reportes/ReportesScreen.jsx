  ...
  return (
    <>
      <style>{`
        ...
        .rep-title i { color: #1a1a1a; }
        .rep-subtitle { font-size: 0.82rem; color: #888; margin: 3px 0 0; }
        ...
        .btn-rep-pdf {
          ...
          border: none !important;
          padding: 9px 16px;
          box-shadow: 0 3px 12px rgba(255,204,0,0.35) !important;
          transition: all 0.2s ease;
        ...
        .tipo-tab:hover { border-color: rgba(255,204,0,0.3); color: #1a1a1a; }
        .tipo-tab.active {
          background: #1a1a1a;
          border-color: transparent; color: #FFCC00;
        ...
        .rep-spinner {
          ...
          color: #888; font-family: 'DM Sans', sans-serif; font-size: 0.9rem;
        }
        .rep-ring {
        ...
        .rep-empty {
          display: flex; flex-direction: column; align-items: center;
          padding: 4rem 2rem; gap: 12px; color: #ccc;
          text-align: center;
        }
        .rep-empty i { font-size: 2.5rem; opacity: 0.4; }
        .rep-empty p { font-size: 0.9rem; margin: 0; }
        .rep-empty small { font-size: 0.78rem; color: #bbb; }
        ...
        .chart-card-icon {
          ...
          font-size: 1rem; background: rgba(255,204,0,0.1); color: #1a1a1a;
        }
        .chart-card-title {
          font-family: 'Arial Black', sans-serif; font-weight: 700;
          font-size: 0.92rem; color: #1a1a1a; margin: 0;
        }
        ...
        .table-count {
          ...
          background: rgba(255,204,0,0.1); color: #1a1a1a;
        ...
        .rep-table tbody tr:hover td { background: rgba(255,204,0,0.03); }
        .rep-table .num-col { font-family: 'Arial Black', sans-serif; font-weight: 700; color: #1a1a1a; }

        /* ── Badges y chips ── */
        .rep-badge { border-radius: 6px; padding: 3px 10px; font-size: 0.73rem; font-weight: 600; }
        .rep-badge.cat { background: rgba(255,204,0,0.1); color: #1a1a1a; }
        .rep-count {
          display: inline-flex; align-items: center; justify-content: center;
          background: #1a1a1a; color: #FFCC00;
          border-radius: 6px; padding: 3px 10px; font-weight: 700;
          font-size: 0.82rem; font-family: 'Arial Black', sans-serif;
        }
            ...
            <div className="periodo-row">
              <div className="periodo-field">
                ...
                <Form.Control
                  ...
                  style={{ borderRadius: 10, borderColor: 'rgba(255,204,0,0.25)', fontSize: '0.875rem' }}
                />
              </div>
              <div className="periodo-field">
              ...
              <Button
                ...
                style={{
                  ...
                  boxShadow: '0 3px 12px rgba(255,204,0,0.3)'
                }}
              >
                {loading
                                ...
                                <tbody>
                                  {datos.toppings.map((item, i) => (
                                    <tr key={i}>
                                      ...
                                      <td style={{ textAlign: 'right', color: '#888' }}>{item.stock_minimo ?? '—'}</td>
                                ...
                                <tbody>
                                  {datos.materias_primas.map((item, i) => (
                                    <tr key={i}>
                                      ...
                                      <td style={{ textAlign: 'right', color: '#888' }}>{item.cantidad_minima ?? '—'}</td>
                                      <td><StockBadge nivel={item.nivel_stock} /></td>
                                    </tr>
                                  ))}
                                </tbody>
      ...
      <Modal show={showMensual} onHide={() => setShowMensual(false)} centered>
          ...
          <Row>
            <Col md={6}>
              <Form.Group className="mb-3">
                <Form.Label style={{ fontSize: '0.75rem', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.06em', color: '#888' }}>
                  Mes
                </Form.Label>
                <Form.Select
                  value={mesAnio.mes}
                  onChange={(e) => setMesAnio(m => ({ ...m, mes: parseInt(e.target.value) }))}
                  style={{ borderRadius: 10, borderColor: 'rgba(255,204,0,0.25)' }}
                >
        ...
        <Modal.Footer style={{ background: '#f9f9f9', borderTop: '1px solid rgba(255,204,0,0.1)', borderRadius: '0 0 16px 16px' }}>
