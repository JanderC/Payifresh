      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "center", minHeight: "60vh", flexDirection: "column", gap: 16 }}>
        <style>{`
          @keyframes steam {
            ...
            50%      { transform: translateY(-6px) scaleX(1.1); opacity: 1; }
          }
        ...
        <div style={{ position: "relative", display: "flex", flexDirection: "column", alignItems: "center", gap: 4 }}>
          ...
          <div style={{ display: "flex", gap: 6, marginBottom: 2 }}>
            {[0, 0.3, 0.15].map((delay, i) => (
              <div key={i} style={{
                width: 4, height: 14, borderRadius: 999,
                background: "linear-gradient(to top, #FFD700, transparent)",
                animation: `steam 1.2s ease-in-out ${delay}s infinite`
              }} />
            ))}
          </div>
          {/* Taza */}
          <div style={{ fontSize: 48, animation: "cup-bounce 1.5s ease-in-out infinite", lineHeight: 1 }}>☕</div>
        </div>
        <p style={{ color: "#1a1a1a", fontFamily: "'DM Sans', sans-serif", fontWeight: 600, margin: 0 }}>Cargando productos...</p>
      </div>
    );
  }
  ...
  return (
    <>
      <style>{`
        ...
        .producto-add-btn:hover { filter: brightness(1.1); box-shadow: 0 5px 16px rgba(0,0,0,0.5); }
        ...
        .carrito-panel {
          ...
          box-shadow: 0 4px 24px rgba(255,204,0,0.1);
          display: flex;
          flex-direction: column;
          overflow: hidden;
          position: sticky;
        ...
        .cliente-input-wrap:focus-within { border-color: #FFCC00; background: #fff; }
        .cliente-input {
          border: none;
          background: transparent;
          font-family: 'DM Sans', sans-serif;
        ...
        .cliente-input::placeholder { color: #ccc; }
        .cliente-clear-btn {
        ...
        .sugerencia-item:hover { background: #f5f5f5; }
        .sugerencia-nombre { font-weight: 600; font-size: 0.9rem; color: #1a1a1a; }
        .sugerencia-tel { font-size: 0.75rem; color: #888; }
        ...
        .carrito-items::-webkit-scrollbar-thumb { background: rgba(255,204,0,0.25); border-radius: 4px; }

        .carrito-empty {
          display: flex; flex-direction: column; align-items: center;
          justify-content: center; padding: 40px 16px; color: #ccc; text-align: center;
        }
        ...
        .carrito-item:hover { border-color: rgba(255,204,0,0.35); }
        .carrito-item.has-extras { border-color: rgba(255,204,0,0.25); background: #f5f5f5; }
        ...
        .qty-btn:hover { background: rgba(255,204,0,0.1); border-color: #FFCC00; }
        ...
        .extras-trigger-btn {
          ...
          border: 1.5px dashed rgba(255,204,0,0.3);
          color: #FFCC00;
          border-radius: 10px;
          padding: 7px 12px;
          font-family: 'DM Sans', sans-serif;
        ...
        .extras-trigger-btn:hover { background: rgba(255,204,0,0.15); border-color: #FFCC00; }
        ...
        .extras-sheet-title {
          font-family: 'Arial Black', sans-serif;
          font-weight: 800; font-size: 1.1rem; color: #1a1a1a;
          display: flex; align-items: center; justify-content: space-between;
        }
        .extras-sheet-subtitle {
          font-size: 0.8rem; color: #888; font-family: 'DM Sans', sans-serif;
          font-weight: 600; margin-top: 2px;
        }
        .extras-sheet-close {
          width: 36px; height: 36px; border-radius: 10px;
          background: rgba(255,204,0,0.1); border: none;
        ...
        .extras-tab-btn:not(.active-sabor):not(.active-toppings):not(.active-siropes) .extras-tab-count {
          background: rgba(255,204,0,0.2); color: #FFCC00; opacity: 1;
        }
        ...
        .extras-options-scroll::-webkit-scrollbar-thumb { background: rgba(255,204,0,0.2); border-radius: 4px; }
        ...
        .extra-option-btn {
          ...
          padding: 14px 10px;
          border-radius: 14px;
          border: 2.5px solid rgba(255,204,0,0.1);
          background: #f9f9f9;
          cursor: pointer;
          touch-action: manipulation;
          -webkit-tap-highlight-color: transparent;
        ...
        .extra-option-precio {
          font-family: 'Arial Black', sans-serif; font-weight: 800;
          font-size: 0.75rem; color: #FFCC00;
          background: rgba(255,204,0,0.1); border-radius: 999px;
        ...
        /* Footer del carrito */
        .carrito-footer {
          border-top: 2px solid rgba(255,204,0,0.1);
        ...
        .monto-input {
          ...
          border: 1.5px solid rgba(255,204,0,0.15); border-radius: 10px;
          padding: 11px 14px; font-family: 'Arial Black', sans-serif; font-weight: 700;
          font-size: 1.1rem; color: #1a1a1a; outline: none;
          transition: border-color 0.2s; box-sizing: border-box;
        }
        .monto-input:focus { border-color: #FFCC00; background: #fff; }
        .monto-input::placeholder { color: #ccc; font-weight: 400; font-size: 0.9rem; }
        ...
        .vuelto-amount { font-family: 'Arial Black', sans-serif; font-weight: 800; font-size: 1.6rem; color: #10b981; }
        ...
        .carrito-fab {
          ...
          box-shadow: 0 8px 28px rgba(0,0,0,0.5); z-index: 999;
          align-items: center; justify-content: center; touch-action: manipulation;
        }
        .carrito-fab-badge {
          position: absolute; top: -4px; right: -4px;
          background: #FFCC00; color: #1a1a1a; border-radius: 999px;
          min-width: 22px; height: 22px; font-family: 'Arial Black', sans-serif;
        ...
        .carrito-overlay {
          ...
          background: rgba(0,0,0,0.55); z-index: 1000; backdrop-filter: blur(4px);
        }
        .carrito-drawer {
        ...
        .drawer-handle {
          width: 40px; height: 4px; background: rgba(255,204,0,0.25);
        ...
        .recientes-title { font-family: 'Arial Black', sans-serif; font-weight: 700; font-size: 0.9rem; color: #1a1a1a; }
        ...
        .recientes-list::-webkit-scrollbar-thumb { background: rgba(255,204,0,0.25); border-radius: 4px; }
        .reciente-item {
          display: flex; align-items: center; gap: 10px; padding: 8px 12px;
          background: #f9f9f9; border-radius: 10px; border: 1px solid rgba(0,0,0,0.05);
          transition: background 0.15s;
        }
        .reciente-item:hover { background: #f0eaf8; }
        .reciente-factura { font-family: 'Arial Black', sans-serif; font-weight: 700; font-size: 0.75rem; color: #FFCC00; min-width: 80px; }
        .reciente-info { flex: 1; min-width: 0; }
        .reciente-cliente { font-size: 0.8rem; font-weight: 600; color: #1a1a1a; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
        .reciente-fecha { font-size: 0.7rem; color: #888; }
        .reciente-total { font-family: 'Arial Black', sans-serif; font-weight: 800; font-size: 0.85rem; color: #1a1a1a; white-space: nowrap; }
        .estado-dot { width: 8px; height: 8px; border-radius: 50%; flex-shrink: 0; }
        .ver-btn-sm {
          background: rgba(255,204,0,0.1); border: none; border-radius: 7px;
          color: #FFCC00; cursor: pointer; padding: 6px 10px;
        ...
        .ver-btn-sm:hover { background: rgba(255,204,0,0.2); }
              ...
              {ventasRecientes.length > 0 && (
                <div className="recientes-section">
                  <div className="recientes-header">
                    <i className="bi bi-clock-history" style={{ color: "#FFCC00", fontSize: "1rem" }}></i>
                  ...
                  <div className="recientes-list">
                    {ventasRecientes.map((venta) => (
                      <div key={venta.id_venta} className="reciente-item">
                        ...
                        <div className="estado-dot" style={{ background: COLORES_ESTADO[venta.estado_venta] || "#888" }}></div>
    ...
    <>
      ...
      <div className="cliente-section">
        ...
        <div className="cliente-input-wrap">
          <i className="bi bi-search" style={{ color: "#ccc", fontSize: "0.85rem", flexShrink: 0 }}></i>
          <input
          ...
          {buscandoCliente && <div className="spinner-sm" style={{ borderColor: "rgba(255,204,0,0.25)", borderTopColor: "#FFCC00", flexShrink: 0 }}></div>}
        </div>
        {clienteSeleccionado && (
